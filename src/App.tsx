                ...
                <div className="w-full px-8 md:px-12 xl:px-16 space-y-12">
                    ...
                    <section className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <div className="group">
                                <label htmlFor="source-dir" className="block text-[10px] font-mono text-on-surface-variant mb-1 ml-1 uppercase tracking-widest cursor-pointer">Source Directory</label>
                            ...
                            <div className="group">
                                <label htmlFor="dest-dir" className="block text-[10px] font-mono text-on-surface-variant mb-1 ml-1 uppercase tracking-widest cursor-pointer">Destination Node</label>
                                <div className={`flex items-center gap-px bg-surface-container-low transition-colors border-b-2 border-transparent ${isRunning ? 'opacity-50' : 'focus-within:bg-surface-container-high focus-within:border-primary'}`}>
                                    <input
                                        id="dest-dir"
                                        className="w-full bg-transparent border-none focus:ring-0 text-sm font-mono text-on-surface py-4 px-4 outline-none"
